...
- [resemble-ai/resemble-enhance: AI powered speech denoising and enhancement](https://github.com/resemble-ai/resemble-enhance/tree/main)
- [timsainb/noisereduce: Noise reduction in python using spectral gating (speech, bioacoustics, audio, time-domain signals)](https://github.com/timsainb/noisereduce)
- [spotify/pedalboard: 🎛 🔊 A Python library for working with audio.](https://github.com/spotify/pedalboard)
